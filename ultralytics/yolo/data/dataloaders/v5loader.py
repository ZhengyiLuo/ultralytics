...
def extract_boxes(path=DATASETS_DIR / 'coco128'):  # from mdm.utils.dataloaders import *; extract_boxes()
...
def autosplit(path=DATASETS_DIR / 'coco128/images', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from mdm.utils.dataloaders import *; autosplit()
    Arguments
...
class HUBDatasetStats():
    ...
    Usage
        from mdm.utils.dataloaders import HUBDatasetStats
